...
# Define paths
AUDIO_DIR = "/media/bwilliams/New Volume/mars_global_acoustic_study/australia_acoustics/raw_audio"
OUTPUT_CSV = "/media/bwilliams/New Volume/mars_global_acoustic_study/australia_acoustics/raw_file_list.csv"
